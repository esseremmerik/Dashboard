...
function tina_mvc_admin_install($upgrading) {
    ...
    if( file_exists( tina_mvc_find_app_install_remove_folder().'/tina_mvc_app_install.php' ) ) {
        
        include( tina_mvc_find_app_install_remove_folder().'/tina_mvc_app_install.php' );
...
function get_tina_mvc_default_page_post_content() {
    ...
    When the Tina MVC plugin is active this content will be overwritten.\r\n\r\n
    ...
    Tina MVC may have 'lost' this front end controller page (this can happen if you edit this page from within Wordpress), deactivate and reactivate Tina MVC to fix this.\r\n\r\n
