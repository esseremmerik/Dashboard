...
if( isset( $form['fields'] ) ) {
    foreach( $form['fields'] as $fieldID ){
        if( isset( $fields[$fieldID] ) ){
            ...
            $html .= "<div class='button'>$fieldTitle ({$fields[$fieldID]['field_type']}) ID:$fieldID<input type='hidden' name='{$fieldPrefix}[fields][]' value='$fieldID' /></div>";
...
if( is_array( $fields ) ){
    foreach( $fields as $fieldID => $fieldData ){
        ...
        $html .= "<div class='button'>$fieldTitle ({$fieldData['field_type']}) ID:$fieldID<input type='hidden' name='{$fieldPrefix}[fields][]' value='$fieldID' /></div>";    
    }
}
$html .= "</div>";
