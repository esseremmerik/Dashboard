    ...
    <div id="dashboard-widgets-wrap">
        <div class="metabox-holder">
            <div id="um_admin_content">
                ...
                $html .= '<p><i>'. sprintf( __( 'Use placeholder <strong>%s</strong> or it will automatically included.', $userMeta->name ), '%reset_password_link%' ) . '</i></p>';         
                ...
                echo $userMeta->actionName( 'saveEmailTemplate' );
