...
class umSupportModel {    
    ...
    function umTest(){
        ...
        //echo $userMeta->userUpdateRegister('profile','profile');
        ...
        //wp_enqueue_style('user-meta', 'http://localhost/wp/wp-content/plugins/user-meta/assets/css/user-meta.css');
        //wp_enqueue_style('user-meta2', 'http://localhost/wp/wp-content/plugins/user-meta/assets/css/user-meta.css');
