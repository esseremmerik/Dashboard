...
function umUserExport( element, type ){
    ...
    var field_count = jQuery( element ).parent("form").children(".um_selected_fields").children(".button").size();
...
function umAddFieldToExport( element ){
    ...
    if(metaKey){
        var button  = '<div class="button">Title:<input type="text" style="width:50%" name="fields['+metaKey+']" value="'+metaKey+'" /> ('+metaKey+')</div>';
